...
public class Base {
    ...
    public WebDriver getLocalDriver(String os, String browserName) {
        if (browserName.equalsIgnoreCase("firefox")) {
            ...
            if (os.equalsIgnoreCase("windows")) {
                System.setProperty("webdriver.chrome.driver", "C:\\Users\\iamam\\IdeaProjects\\Amazon\\Generic\\src\\main\\driver\\chromedriver.exe");
            } else {
                System.setProperty("webdriver.chrome.driver", "C:\\Users\\iamam\\IdeaProjects\\Amazon\\Generic\\src\\main\\driver\\chromedriver.exe");
            }
    ...
    public void takeTheScreenshot(String testCaseName) throws Exception {
        Thread.sleep(3000);
        String screenShotLocation = "C:\\Users\\iamam\\Dropbox\\Amazon\\Buncee\\src\\test\\TestResult\\Screenshot\\";
